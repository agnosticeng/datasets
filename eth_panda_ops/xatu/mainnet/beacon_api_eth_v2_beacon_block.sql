create or replace view eth_panda_ops__xatu__mainnet__beacon_api_eth_v2_beacon_block as (
    with 
        (
            select arrayMap(
...
comment $comment${
    ...
    "usage": "select * from beacon_api_eth_v2_beacon_block(network = 'mainnet', from='2023-11-14', to='2023-11-16') limit 10",
    "columns": [
