create or replace view eth_panda_ops__xatu__mainnet__canonical_beacon_block_attester_slashing as (
    with 
        (
            select arrayMap(
                x -> toDate(x),  
    ...
    select 
        ...
        *
    from s3(
        'https://data.ethpandaops.io/xatu/' || {network:String} || '/databases/default/canonical_beacon_block_attester_slashing/' || files_pattern || '.parquet',
        'Parquet',
        $heredoc$
            ...
            attestation_1_attesting_indices Array(Nullable(UInt32)),
            attestation_1_signature Nullable(String),
            attestation_1_data_beacon_block_root Nullable(FixedString(66)),
            attestation_1_data_slot Nullable(UInt32),
            attestation_1_data_index Nullable(UInt32),
            attestation_1_data_source_epoch Nullable(UInt32),
            attestation_1_data_source_root Nullable(FixedString(66)),
            attestation_1_data_target_epoch Nullable(UInt32),
            attestation_1_data_target_root Nullable(FixedString(66)),
            attestation_2_attesting_indices Array(Nullable(UInt32)),
            attestation_2_signature Nullable(String),
            attestation_2_data_beacon_block_root Nullable(FixedString(66)),
            attestation_2_data_slot Nullable(UInt32),
            attestation_2_data_index Nullable(UInt32),
            attestation_2_data_source_epoch Nullable(UInt32),
            attestation_2_data_source_root Nullable(FixedString(66)),
            attestation_2_data_target_epoch Nullable(UInt32),
            attestation_2_data_target_root Nullable(FixedString(66)),
...
comment $comment${
    "short": "Contains attester slashing from a beacon block.",
    "url": "https://ethpandaops.io/data/xatu/schema/canonical_beacon_/",
    "usage": "select * from canonical_beacon_block_attester_slashing(network = 'mainnet', from='2020-12-01', to='2020-12-03') limit 10",
    "columns": [
        ...
        {"name": "attestation_1_attesting_indices", "type": "Array(Nullable(UInt32))"},
        {"name": "attestation_1_signature", "type": "Nullable(String)"},
        {"name": "attestation_1_data_beacon_block_root", "type": "Nullable(FixedString(66))"},
        {"name": "attestation_1_data_slot", "type": "Nullable(UInt32)"},
        {"name": "attestation_1_data_index", "type": "Nullable(UInt32)"},
        {"name": "attestation_1_data_source_epoch", "type": "Nullable(UInt32)"},
        {"name": "attestation_1_data_source_root", "type": "Nullable(FixedString(66))"},
        {"name": "attestation_1_data_target_epoch", "type": "Nullable(UInt32)"},
        {"name": "attestation_1_data_target_root", "type": "Nullable(FixedString(66))"},
        {"name": "attestation_2_attesting_indices", "type": "Array(Nullable(UInt32))"},
        {"name": "attestation_2_signature", "type": "Nullable(String)"},
        {"name": "attestation_2_data_beacon_block_root", "type": "Nullable(FixedString(66))"},
        {"name": "attestation_2_data_slot", "type": "Nullable(UInt32)"},
        {"name": "attestation_2_data_index", "type": "Nullable(UInt32)"},
        {"name": "attestation_2_data_source_epoch", "type": "Nullable(UInt32)"},
        {"name": "attestation_2_data_source_root", "type": "Nullable(FixedString(66))"},
        {"name": "attestation_2_data_target_epoch", "type": "Nullable(UInt32)"},
        {"name": "attestation_2_data_target_root", "type": "Nullable(FixedString(66))"},
