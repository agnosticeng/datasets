create or replace view eth_panda_ops__xatu__mainnet__beacon_api_eth_v1_events_chain_reorg as (
    with 
        (
            select arrayMap(
    ...
    select 
        ...
        *
    from s3(
        'https://data.ethpandaops.io/xatu/' || {network:String} || '/databases/default/beacon_api_eth_v1_events_chain_reorg/' || files_pattern || '.parquet',
        'Parquet',
        $heredoc$
            ...
            old_head_block Nullable(FixedString(66)),
            new_head_block Nullable(FixedString(66)),
            old_head_state Nullable(FixedString(66)),
            new_head_state Nullable(FixedString(66)),
...
comment $comment${
    "short": "Contains beacon API eventstream “chain reorg” data from each sentry client attached to a beacon node.",
    "url": "https://ethpandaops.io/data/xatu/schema/beacon_api_/",
    "usage": "select * from beacon_api_eth_v1_events_chain_reorg(network = 'mainnet', from='2023-03-01', to='2023-03-03') limit 10",
    "columns": [
        ...
        {"name": "depth", "type": "Nullable(UInt16)"},
        {"name": "old_head_block", "type": "Nullable(FixedString(66))"},
        {"name": "new_head_block", "type": "Nullable(FixedString(66))"},
        {"name": "old_head_state", "type": "Nullable(FixedString(66))"},
        {"name": "new_head_state", "type": "Nullable(FixedString(66))"},
