create or replace view eth_panda_ops__xatu__mainnet__canonical_beacon_block_proposer_slashing as (
    with 
        (
            select arrayMap(
                x -> toDate(x),  
    ...
    select 
        ...
        *
    from s3(
        'https://data.ethpandaops.io/xatu/' || {network:String} || '/databases/default/canonical_beacon_block_proposer_slashing/' || files_pattern || '.parquet',
        'Parquet',
        $heredoc$
            ...
            signed_header_1_message_slot Nullable(UInt32),
            signed_header_1_message_proposer_index Nullable(UInt32),
            signed_header_1_message_body_root Nullable(FixedString(66)),
            signed_header_1_message_parent_root Nullable(FixedString(66)),
            signed_header_1_message_state_root Nullable(FixedString(66)),
            signed_header_1_signature Nullable(String),
            signed_header_2_message_slot Nullable(UInt32),
            signed_header_2_message_proposer_index Nullable(UInt32),
            signed_header_2_message_body_root Nullable(FixedString(66)),
            signed_header_2_message_parent_root Nullable(FixedString(66)),
            signed_header_2_message_state_root Nullable(FixedString(66)),
            signed_header_2_signature Nullable(String),
...
comment $comment${
    ...
    "columns": [
        ...
        {"name": "signed_header_1_message_slot", "type": "Nullable(UInt32)"},
        {"name": "signed_header_1_message_proposer_index", "type": "Nullable(UInt32)"},
        {"name": "signed_header_1_message_body_root", "type": "Nullable(FixedString(66))"},
        {"name": "signed_header_1_message_parent_root", "type": "Nullable(FixedString(66))"},
        {"name": "signed_header_1_message_state_root", "type": "Nullable(FixedString(66))"},
        {"name": "signed_header_1_signature", "type": "Nullable(String)"},
        {"name": "signed_header_2_message_slot", "type": "Nullable(UInt32)"},
        {"name": "signed_header_2_message_proposer_index", "type": "Nullable(UInt32)"},
        {"name": "signed_header_2_message_body_root", "type": "Nullable(FixedString(66))"},
        {"name": "signed_header_2_message_parent_root", "type": "Nullable(FixedString(66))"},
        {"name": "signed_header_2_message_state_root", "type": "Nullable(FixedString(66))"},
        {"name": "signed_header_2_signature", "type": "Nullable(String)"},
