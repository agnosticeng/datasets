create or replace view eth_panda_ops__xatu__mainnet__beacon_api_eth_v1_proposer_duty as (
    with 
        (
            select arrayMap(
...
comment $comment${
    ...
    "usage": "select * from beacon_api_eth_v1_proposer_duty(network = 'mainnet', from='2024-04-03', to='2024-04-05') limit 10",
    "columns": [
